...
VisX advances medical AI research by providing a transparent, interactive platform for interpreting vision
              model outputs. Through intuitive visualizations and LLM-driven explanations, we enable researchers and
              clinicians to explore model behavior, improving reliability and trust.
    </p>
    </div>
